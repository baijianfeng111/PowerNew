...
(function (factory) {
    ...
    tProgress = '<div class="progress">\n' +
        ...
        '     </div>\n' +
        '</div>';
    tSize = ' <br><samp class="saurl" data-saurl="2222" >({sizeText})</samp>';
    ...
    defaultFileTypeSettings = {
        ...
        video: function (vType, vName) {
            return compare(vType, 'video.*') && (compare(vType, /(ogg|mp4|mp?g|webm|3gp|flv)$/i) ||
                compare(vName, /\.(og?|mp4|webm|mp?g|3gp|flv)$/i));
        },
        ...
        _readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                if (!canPreview && fileSize > maxPreviewSize) {
                    ...
                    msg = self.msgMaxsize.replace('{name}',caption).replace('{extensions}',maxPreviewSize/1024+"M");
                    self.isError = throwError(msg, file, previewId, i);
                    return;
                    //self.addToStack(file);
    ...
    $.fn.fileinputLocales.zh = {
        ...
        msgMaxsize: '文件"{name}"的上传限度超过"{extensions}".',
